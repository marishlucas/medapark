      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12">
          ...
          <div className="sm:col-span-12 lg:col-span-4 lg:max-w-xs">
            <div className="mb-2">
              ...
              <Link
                href="/"
                className="inline-flex text-orange-600 transition duration-150 ease-in-out"
                aria-label="MedaPark"
              >
                <svg
            ...
            <div className="text-lg font-bold text-slate-800">
              Soluții durabile pentru infrastructura ta urbană.
            </div>
          </div>
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="text-sm font-medium space-y-2">
              <li>
                <a
                  href="#"
                  className="text-slate-500 hover:text-orange-600 transition duration-150 ease-in-out"
                >
                  Prezentare generală
                </a>
              </li>
        ...
        <div className="md:flex md:items-center md:justify-between py-6 md:py-8 border-t border-slate-200">
          ...
          <ul className="flex space-x-6 mb-4 md:order-1 md:ml-4 md:mb-0">
            <li>
              <a
                className="text-orange-600 hover:text-orange-700 transition duration-150 ease-in-out"
                href="#0"
                aria-label="Twitter"
              >
                <svg
          ...
          <div className="text-sm text-slate-500 mr-4">
            © 2024 MedaPark. Toate drepturile rezervate.
          </div>
        </div>
      </div>
    </footer>
