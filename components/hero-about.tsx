...
export default function HeroAbout() {
  return (
    <section className="relative">
      {/* Dark background */}
      <div
        className="absolute inset-0 bg-slate-200 pointer-events-none -z-10 mb-48 lg:mb-0 lg:h-[30rem]"
        aria-hidden="true"
      >
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 md:pt-40">
          ...
          <div className="max-w-3xl mx-auto text-center pb-16">
            <h1 className="h1 font-playfair-display text-slate-900">
              Avem idei si le practicam.
            </h1>
          </div>
